    ...
    <div class="pages">
        <div class="card">
            <div class="card-header">
                ...
                <span class="title">Edit Pengeluaran PPGT</span>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('pengeluaran.update', $pengeluaran->id) }}" method="POST"
                    ...
                    <input type="text" name="keterangan" id="keterangan" class="form-control mb-4"
                        placeholder="Keterangan Pengeluaran" value="{{ $pengeluaran->keterangan }}">

                    <label for="jumlah" class="mb-2">Nominal <span class="star">*</label>
                    <input type="number" name="jumlah" id="jumlah" class="form-control mb-4"
                        placeholder="Masukkan Nominal Pengeluaran" value="{{ $pengeluaran->jumlah }}">

                    <label for="catatan" class="mb-2">Catatan </label>
                    <textarea name="catatan" id="catatan" cols="30" rows="10" class="form-control">{!! $pengeluaran->catatan !!}</textarea>
