    ...
    <div class="pages">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('notulensi-rapat.update', $notulen->id) }}" method="POST"
                    ...
                    <textarea name="isi" id="isi" cols="30" rows="10">{!! $notulen->isi !!}</textarea>

                    <label for="file" class="mt-4 mb-2">File </label>
